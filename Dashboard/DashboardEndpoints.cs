...
public static class DashboardEndpoints
{
    ...
    public static IEndpointRouteBuilder MapDashboard(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPut("/api/settings", (BotSettingsStore settings, DashboardSettingsRequest request) =>
        {
            ...
            var current = settings.Update(request.Token, request.Prefix, request.DevelopmentGuildId,
        ...
        app.MapPut("/api/guilds/{guildId}/settings",
            (ulong guildId, BotSettingsStore settings, GuildSettingsRequest request) =>
            {
        ...
        app.MapPut("/api/guilds/{guildId}/autorole",
            (ulong guildId, BotSettingsStore settings, AutoRoleRequest request) =>
            {
                var roleIds = request.RoleIds ?? [];
                if (roleIds.Count > 20) return Results.BadRequest("Autorole supports up to 20 roles.");
